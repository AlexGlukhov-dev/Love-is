...
const webpImages = () => {
  return src([`${paths.srcImgFolder}/**/**.{jpg,jpeg,png,mp4}`])
    .pipe(webp())
    .pipe(dest(paths.buildImgFolder))
};
...
const watchFiles = () => {
  ...
  watch(`${paths.srcImgFolder}/**/**.{jpg,jpeg,png,svg,mp4}`, images);
  watch(`${paths.srcImgFolder}/**/**.{jpg,jpeg,png,mp4}`, webpImages);
 // watch(`${paths.srcImgFolder}/**/**.{jpg,jpeg,png,mp4}`, avifImages);
  watch(paths.srcSvg, svgSprites);
}

const cache = () => {
  return src(`${buildFolder}/**/*.{css,js,svg,png,jpg,jpeg,webp,woff2,mp4}`, {
      base: buildFolder
    })
    .pipe(rev())
    .pipe(revDel())
